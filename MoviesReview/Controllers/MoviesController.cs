...
namespace MoviesReview.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,GenereID,ImageUrl,TrailerUrl")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,GenereID,ImageUrl,TrailerUrl")] Movie movie)
        {
            if (ModelState.IsValid)
            {
