...
namespace MoviesReview.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movies = db.Movies.Include(m => m.Genere);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,GenereID,ImageUrl,TrailerUrl,xLocation,yLocation")] Movie movie)
        {
            ...
            ViewBag.GenereID = new SelectList(db.Generes, "Id", "Name", movie.GenereID);
            return View(movie);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,GenereID,ImageUrl,TrailerUrl,xLocation,yLocation")] Movie movie)
        {
            if (ModelState.IsValid)
            {
